...
const openSourceProjects = [
  ...
  },
  {
    ...
    protocol: "Tool",
    description:
      "Open source QR code tool for BAS workflows.",
    githubUrl: "https://rbhans.github.io/qrbas/",
  },
  {
    id: "opencrate-bms",
    name: "OpenCrate BMS",
    ...
    <div className="min-h-full">
      ...
      <div className="title-block">
        ...
        <div className="field">
          ...
          <span className="field-value">Open Source BAS Tools</span>
        </div>
        <div className="field">
          <span className="field-label">Items</span>
          <span className="field-value tabular-nums">{openSourceProjects.length}</span>
        </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-16 pt-16 pb-16 max-w-[1100px]">
        <p className="font-heading italic text-[17px] text-muted-foreground text-center mb-12 leading-[1.5] max-w-[640px] mx-auto">
          Rust crates and tools for building BAS software from the ground up. Protocol-first, practical, open source.
        </p>
