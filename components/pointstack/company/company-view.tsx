                ...
                if (member.profile?.display_name) {
                  return (
                    <Link
                      ...
                      className="flex items-center gap-3 p-3 border border-border rounded-xl bg-card hover:border-foreground/20 transition-colors duration-200"
                    >
                      {memberContent}
                    </Link>
                  );
            ...
            <div className="space-y-3">
              {companyProjects.map((project) => (
                <Link
                  ...
                  className="block rounded-xl border border-border bg-card hover:border-foreground/20 transition-colors duration-200 p-4"
                >
