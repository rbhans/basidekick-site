...
-- ============================================================
-- Creates a system profile for BASidekick and inserts three
-- community-seeding posts about upcoming features and resources.
-- Runs with service_role privileges (bypasses RLS).
-- ============================================================

-- Ensure a BASidekick system profile exists for authoring seed content.
-- Uses a deterministic UUID so re-runs are idempotent.
INSERT INTO auth.users (id, email, role, aud, created_at, updated_at)
VALUES (
  '00000000-0000-0000-0000-000000000001',
  'system@basidekick.com',
  'authenticated',
  'authenticated',
  now(),
  now()
...
INSERT INTO public.profiles (id, display_name, avatar_url, headline)
VALUES (
  '00000000-0000-0000-0000-000000000001',
  'BASidekick',
  NULL,
  'Building automation tools for the modern technician'
)
