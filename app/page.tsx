...
const viewRegistry: Record<string, React.ComponentType<{ onNavigate: (viewId: string) => void }>> = {
...
export default function HomePage() {
  ...
  const renderView = () => {
    ...
    if (TOOL_DETAILS[activeView]) {
      return <ToolDetailView toolId={activeView as "nsk" | "ssk" | "msk"} onNavigate={handleViewChange} />;
    }
